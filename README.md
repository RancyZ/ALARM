...
```
3. The repository contains two case studies: Smart Home and Wound. Each case study is organized into two subfolders: one for code and one for data.
4. Smart Home case study:
